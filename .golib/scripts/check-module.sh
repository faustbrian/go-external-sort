...
run_gate() {
    ...
    case "${selected}" in
        ...
        licenses)
            ...
            if [[ "${module_path}" != "github.com/faustbrian/go-external-sort" &&
                "${module_path}" != github.com/faustbrian/go-external-sort/* ]]; then
            ...
            run_go_tool \
                ...
                go-licenses \
                check ./... \
                --ignore "github.com/faustbrian/go-external-sort"
            ;;
        sbom)
            applicable security || { skip_not_applicable security; return; }
